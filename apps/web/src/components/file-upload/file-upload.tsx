  ...
  return (
    <div className="w-full h-[100vh] border flex justify-center items-center text-6xl font-bold ">
      <div className=" xl:w-[50%] max-xl:w-[65%]  h-[70%] flex justify-between rounded-3xl backdrop-blur-md border-2 border-[#110f40] shadow-2xl bg-[#19183B]">
        <div
          className={`bg-transparent w-full rounded-l-3xl flex justify-center items-center max-lg:hidden `}
        >
          <div className="p-3 flex flex-row  text-foreground font-bold text-xl gap-[.6rem] justify-center items-center">
            ...
            <span className="text-[#F1F1F9] flex flex-row justify-center items-end text-3xl">
              Namestack
            </span>
          </div>
        </div>
        ...
        <div
          id="float"
          className="w-full text-center py-8 flex flex-col rounded-3xl gap-16 justify-center items-center bg-[#f5f6f6] hover:translate-x-[-1rem] transition duration-800"
        >
          ...
          : <div
              className={`bg-gray-400 w-[78%] text-base rounded-2xl h-[33%] flex flex-col font-normal justify-center items-center gap-7 ${uploadError ? 'py-4' : 'py-0'}`}
            >
