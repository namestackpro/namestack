  ...
  return (
    <div className="w-auto h-full">
      <div className="flex items-center justify-end px-2 max-md:px-5 py-[0.88rem] w-full">
        <div
          className={`flex items-center justify-center gap-3 pr-8 max-md:pr-4 ${isMainDashboard ? 'ml-auto' : ''} border border-red-300 py-1`}
        >
          {!isMainDashboard && <Icon className={`h-6 w-7 ${Color}`} />}
          <span className="text-foreground font-semibold text-sm max-md:text-sm">
