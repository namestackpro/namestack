  ...
  return (
    ...
    <div className="grid max-lg:grid-cols-1 lg:grid-cols-4 gap-6 mb-2 ">
      ...
      {stats.map((stat, index) => (
        <Card key={index} className="bg-inherit rounded-2xl shadow-lg  transition-all duration-700 hover:scale-105 hover:shadow-xl hover:bg-card/80 border border-gray-200 flex flex-row items-center justify-center max-lg:justify-start max-lg:gap-10 max-lg:px-8 gap-2 px-4 lg:py-4">
